...
RABBITMQ_ADDR = os.environ['RABBITMQ_PORT_5672_TCP_ADDR']
RABBITMQ_PORT = os.environ['RABBITMQ_PORT_5672_TCP_PORT']
BROKER_URL = 'amqp://renette:renette@%s:%s/renette' % (RABBITMQ_ADDR, RABBITMQ_PORT)
